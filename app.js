...
app.use("/", express.static(path.join(__dirname, "dist/week9Ang")));
...
app.delete('/movie/:year',movieRouter.deleteMovieByYear);
app.get("/showactors/movies/:rating",movieRouter.getMovieByRating);